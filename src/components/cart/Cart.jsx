        ...
        <div className="fixed inset-0 overflow-hidden">
          <div className="absolute inset-0 overflow-hidden">
            <div className="fixed inset-y-0 right-0 flex max-w-full pl-10 sm:pl-16 mt-19">
              <DialogPanel
                transition
                className="pointer-events-auto w-screen max-w-md transform transition duration-500 ease-in-out data-[state=closed]:translate-x-full sm:duration-700 mr-40"
              >
                {/* height */}
                                ...
                                <div className="flex-1 pr-4 flex flex-col justify-between">
                                  <div>
                                    ...
                                    {Object.entries(item)
                                      ...
                                      .map(([attributeName, selectedValue]) => (
                                        <div
                                          key={attributeName}
                                          className="mt-2"
                                        >
                                          ...
                                          <div className="mt-2 flex gap-2 flex-wrap">
                                            <div
                                              className={`cursor-default border rounded flex items-center justify-center transition duration-200 box-border
    ${
      attributeName.toLowerCase() === "color"
        ? "w-10 h-10 border border-gray-300"
        : "px-4 py-1 text-sm bg-white text-black border-black"
    }`}
                                              style={{
                                                backgroundColor:
